...
const book1 = new Book_1.Book("0596101015", "Php cookbook", "David Sklar", 3400);
//book1.bookId = "000";
console.log(book1.bookId);
const book2 = new Book_1.Book("67890", "JavaScript Mastery", "Author2", 2500);
const user1 = new User_1.User("765", "John Smith", "js76@MediaList.com");
